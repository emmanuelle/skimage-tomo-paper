...
\begin{abstract} % abstract
    ...
    image processing capabilities, and the scalable performances required
...
by explanatory text, equations and visualizations (Fig.~\ref{fig:jupyter}).
...
\begin{figure*}
    \centerline{\includegraphics[width=0.99\textwidth]{jupyter_example}}
...
Fig.~\ref{fig:tomo_gallery}). Region-growing algorithms, such as the
...
Fig.~\ref{fig:tomo_gallery}). The active contour algorithm
