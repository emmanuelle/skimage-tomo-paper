...
\title{Analyzing tomographic images in Python with scikit-image}
...
\texttt{scikit-image} has a very simple API, based almost only on
...
(\textcolor{blue}{or is it a tree?})
(rather than a linear pipeline), where nodes are image-shaped arrays, and
...
\emma{Juan or Stéfan, can you add something about dask?}

Prototyping the image processing workflow requires several trial and error
